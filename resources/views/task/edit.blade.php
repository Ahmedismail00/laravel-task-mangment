...
@section('content')
    <form action="{{ route('task.update',$record->id) }}" method="POST" >
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="priority" type="number" class="form-control" id="exampleInputPriority" required value="{{$record->priority}}">
        </div>
